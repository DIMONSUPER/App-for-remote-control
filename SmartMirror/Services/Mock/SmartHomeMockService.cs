...
namespace SmartMirror.Services.Mock
{
    public class SmartHomeMockService : ISmartHomeMockService
    {
        ...
        public IEnumerable<RoomModel> GetRooms()
        {
            ...
            {
                new() { Id = "real2.9999738989430480896", Name = "Dining Room", Description = "0 Accessories"},
                new() { Id = "real2.9999738989430480896", Name = "Downstairs", Description = "0 Accessories"},
                new() { Id = "real2.9999738989430480896", Name = "Front Door", Description = "0 Accessories"},
                new() { Id = "real2.9999738989430480896", Name = "Garage", Description = "0 Accessories" },
            };
