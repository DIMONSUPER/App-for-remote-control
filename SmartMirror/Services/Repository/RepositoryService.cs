...
namespace SmartMirror.Services.Repository;
...
public class RepositoryService : IRepositoryService
{
    ...
    private Lazy<SQLiteAsyncConnection> CreateLazySQLiteConnection()
    {
        return new(() =>
        {
            ...
            database.CreateTableAsync<DeviceDTO>().Wait();
            database.CreateTableAsync<RoomDTO>().Wait();
            database.CreateTableAsync<ScenarioDTO>().Wait();
